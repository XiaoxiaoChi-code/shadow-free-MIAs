...
def step0(file1, file2):
    ...
    fuser = open("processed_amazon/Beauty_usermap", 'w')
    fitem = open("processed_amazon/Beauty_itemmap", 'w')
...
if __name__ == '__main__':
    ...
    filename1 = "processed_amazon/ratings_Beauty_after_step0.csv"
